...
class Flashbots(Module):
    ...
    def simulate(
        ...
        print("evm_timestamp", evm_timestamp)
        signed_bundled_transactions = self.sign_bundle(bundled_transactions)
        print("signed_bundled_transactions", signed_bundled_transactions)
        # calls evm simulator
